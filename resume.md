...
**AI Systems Engineer · Full-Stack Developer · Data Engineer**
...
🔗 [GitHub](https://github.com/Mhmdaris15) · [LinkedIn](http://linkedin.com/in/muhammad-aris-septanugroho) · [Portfolio](https://aris-portfolio.vercel.app)
...
- ⚙️ Built and operates **10+ production automation systems** for client reporting
- 🥇 **1st Place — LKS Data Science West Java 2023**
- 💬 Shipped **WhatsApp RAG bots, restaurant ordering platforms, and live tournament scoring systems** — all in production

---

## Experience

### Demandlane (Performek Inc.) — Data Scientist / Analytics Engineer
*Remote · April 2024 – March 2026*
...
- Led the migration of analytics infrastructure from Google Sheets to **AWS Redshift**, improving query performance and pipeline reliability
...
**Stack:** Python · SQL · AWS Redshift · dbt · Tableau · n8n · Scikit-learn · XGBoost · CatBoost · Slack API

---

### Mija Company — Full-Stack Developer
*Jakarta, Indonesia · November 2023 – May 2024*
...
### PBSI (Indonesian Badminton Association) — Backend Developer (Freelance)
*Bandung, Indonesia · July 2023 – October 2023*
...
### RecursiveDine — Full-Stack Restaurant Platform
...
> Full case studies and 25+ additional projects: [aris-portfolio.vercel.app/myworks](https://aris-portfolio.vercel.app/myworks)

---

## Skills

**Languages:** Python · SQL · Golang · TypeScript / JavaScript

**AI / ML:** LLMs (Gemini, OpenAI, DeepSeek, Qwen) · RAG · Vector DBs (ChromaDB, FAISS, pgvector) · Scikit-learn · XGBoost · CatBoost · vLLM · Prompt Engineering · MCP

**Data Engineering:** AWS Redshift · dbt · ETL Pipelines · Polars · Pandas · Tableau · API Integration · Data Modeling

**Backend & Web:** FastAPI · Flask · NestJS · Node.js · Next.js · React · WebSockets · REST APIs

**DevOps & Cloud:** Docker · Google Cloud Run · AWS · Cloudflare Tunnel · CI/CD · VM Deployment · Monitoring & Alerting

**Automation:** n8n · Workflow Automation · Scheduler Systems · Selenium · Webhooks

---

## Freelance Services

Open for short-term and retainer engagements:

- **Landing Pages & Marketing Sites** — from $300, 1–2 weeks
- **Full-Stack MVPs** — from $1,500, 3–6 weeks
- **AI / RAG Chatbot Integration** — from $800, 2–4 weeks
- **Data Analytics & Automation** — from $500, 1–3 weeks
- **Real-time Systems** — from $1,200, 2–5 weeks

---

## Education

**ITMO University** — Neurotechnology and Programming *(In Progress)*
Saint Petersburg, Russia

**SMKN 1 Cibinong** — Informatics, Networking and Applications · Graduated 2024
- Best Student (Top 1, Semesters 1–4)
...
- Writes about software engineering and AI on [my blog](https://aris-portfolio.vercel.app/blog)

---

*Last updated: May 2026 · Available for engagements starting immediately.*
