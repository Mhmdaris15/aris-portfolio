      ...
      <div className="what-box">
        <div className="what-box-in what-box-in--three">
          ...
          <div className="what-content what-noTouch" ref={(el) => setRef(el, 2)}>
            ...
            <div className="what-corner"></div>
            <div className="what-content-in">
              <h3>{t(config.skills.infra.title, locale)}</h3>
              <h4>{t(config.skills.infra.description, locale)}</h4>
              <p>{t(config.skills.infra.details, locale)}</p>
              <h5>{t(dict.whatIDo.skillset, locale)}</h5>
              <div className="what-content-flex">
                {config.skills.infra.tools.map((tool, index) => (
                  <div key={index} className="what-tags">
                    {tool}
                  </div>
                ))}
