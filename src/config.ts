export const config = {
    developer: {
        ...
        description: "Software Engineer & Full-Stack Developer building modern web applications, microservices, and data-driven solutions. Passionate about Golang, Python, and creating scalable systems."
    },
    social: {
        github: "Mhmdaris15",
    ...
    projects: [
        {
            ...
            category: "Full Stack",
            technologies: "Nest.js, React, Docker, GCP, PostgreSQL, Payment Gateway",
            image: "/images/project-1.webp",
            description: "A comprehensive restaurant management system for handling orders, menus, and payments. Features a PWA for mobile access, integrated payment gateways, and VPS deployment with Docker on GCP."
        },
        {
            id: 2,
            title: "PBSI Match Management",
            category: "Full Stack / Real-time",
            technologies: "Golang, React.js, WebSockets, Real-time Scoring",
            image: "/images/project-2.webp",
            description: "A real-time badminton match management system for PBSI. Features live scoring via WebSockets, match scheduling, bracket generation, and score tracking for professional tournaments."
        },
        {
            id: 3,
            ...
            description: "A modern voting application for student council board elections. Features a dashboard to manage students, candidates, and voting results with secure authentication and real-time vote counting."
        },
        {
            id: 4,
            ...
            description: "An AI-powered attendance system using face recognition technology. Detects and recognizes faces in real-time video streams for automated attendance tracking in educational institutions."
        },
        {
            id: 5,
            title: "KIsA Promotion Website",
            category: "Web Development",
            technologies: "React, Firebase, Frontend Development",
            image: "/images/project-5.webp",
            description: "A promotional website for Kampung Inggris Pare built during an internship. Features modern UI/UX design, Firebase integration for data management, and responsive layouts for all devices."
        },
        {
            id: 6,
            title: "Data Science Competition Projects",
            category: "Data Science / ML",
            technologies: "Python, Pandas, Scikit-learn, TensorFlow, NLP",
            image: "/images/placeholder.webp",
            description: "Award-winning data science projects from KKSI and LKS competitions. Includes time series analysis for currency prediction, sentiment analysis for tweet classification, and face recognition systems. Won 1st Place at LKS Data Science West Java Province 2023."
        }
    ],
    contact: {
        email: "muhammadaris1945@gmail.com",
    ...
    skills: {
        ...
        design: {
            ...
            details: "Building data-driven solutions with Python, TensorFlow, and modern ML frameworks. Experience in face recognition, time series analysis, sentiment analysis, and data visualization. Award-winning data science competitor.",
            tools: ["TensorFlow", "OpenCV", "Scikit-learn", "Pandas", "NumPy", "Python", "Data Visualization", "NLP", "Face Recognition", "Time Series"]
        }
    }
};
